 ...
 */
public class AlternateMain extends ApplicationAdapter {
    static {
        AssetData.TILE_WIDTH = 16;
        AssetData.TILE_HEIGHT = 8;
        AssetData.TILE_DEPTH = 16;
        AssetData.pathTile = 3;
    }
    /**
     ...
     * <a href="https://gvituri.itch.io/isometric-trpg">these free-to-use assets by Gustavo Vituri</a>,
     * <a href="https://ray3k.wordpress.com/clean-crispy-ui-skin-for-libgdx/">a skin originally by Raymond Buckley</a>,
     * and environment assets by Studio Faewilds and infrared baron.
     * <br>
     * CUSTOM TO YOUR GAME. This is closely related to {@link AssetData}, and if one changes, both should.
     */
    public static final String ATLAS_FILE_NAME = "studio-faewilds.atlas";
    /**
...
//        ((ScreenViewport)stage.getViewport()).setUnitsPerPixel(1f/2f); // 1f/2f will double the size of the Stage.
    ...
    public void render() {
        ...
        if(fish instanceof AnimatedIsoSprite && fish != player.visual){
            ...
            ((AlternateMain)Gdx.app.getApplicationListener()).updateFish();
        }
